...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "记录技术、动漫、游戏以及各种乱七八糟的想法。",

	// 站点 URL
	site_url: "https://blog.stickman.life",
	...
	// bangumi配置
	bangumi: {
		// Bangumi用户ID（启用 pages.bangumi 后请填入自己的 ID）
		userId: "",
	...
	// 以下页面默认随主题附带演示内容，已暂时关闭，配置好自己的内容后再逐个开启
	pages: {
		// 友链页面开关（需在 friendsConfig.ts 配置自己的友链后再开启）
		friends: false,
		// 赞助页面开关（需在 sponsorConfig.ts 配置自己的收款码后再开启）
		sponsor: false,
		// 留言板页面开关，需要先配置评论系统（commentConfig.ts）
		guestbook: true,
		// 番组计划页面开关，需要先配置 bangumi.userId
		bangumi: false,
		// 相册页面开关（相册数据在 galleryConfig.ts 配置，目前为空，请填入自己的相册）
		gallery: true,
	},
